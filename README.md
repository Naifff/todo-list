...
Картинка обзорная: весь день или неделя видны сразу, открывается в один тап, но кнопок на ней нет
и быть не может. Страница приходит HTML-файлом: она подстраивается под экран, листается и вмещает
то, чего в картинку не влезает — место, исполнителя, статус, причину отказа и дела без даты.
