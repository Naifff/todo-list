...
- **Расписание** на день, три дня, неделю или месяц: списком, картинкой-календарём или страницей.
...
| `/agenda` | Расписание на 1, 3, 7 или 30 дней — списком, картинкой или страницей |
...
Оба вида — сетка: ось часов с колонками дней до недели, месячная сетка неделями дальше. Картинка
открывается в один тап и вся видна сразу, но кнопок на ней нет и быть не может. Страница приходит
HTML-файлом: она листается, увеличивается и вмещает то, чего в картинку не влезает — место,
исполнителя, статус, причину отказа и дела без даты.
