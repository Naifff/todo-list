...
public final class Texts {
    ...
    public static final String MAIN_MENU =
            ...
            /new — попросить кого-то о деле; можно сразу строкой
    ...
    /**
     * Подсказка про строку целиком нужна ровно здесь: сама возможность ниоткуда не видна, а
     * возможность, о которой не знают, не существует.
     */
    public static final String ASK_TASK_TITLE =
            """
            Что нужно сделать?

            Можно сразу целиком: <code>сходить на ролики 14.08 18:30-20:00 цирк</code>""";
    ...
    public static final String SCHOOL_WHOSE = "Чьё расписание?";

    public static final String SCHOOL_NO_PUPILS =
            "В семье пока нет детей — расписание заводится им.";

    /**
     * Пустой экран обязан показывать формат: язык ввода ниоткуда больше не виден, а без него кнопка
     * «Заменить» приводит к пустому полю и вопросу «а как писать?».
     */
    public static final String SCHOOL_EMPTY = "Расписание не заведено.";

    public static final String SCHOOL_REPLACE = "✏️ Заменить";

    public static final String SCHOOL_CLEAR = "🧹 Очистить";

    public static final String SCHOOL_ASK =
            """
            Пришли расписание одним сообщением.

            <code>Звонки: 08:30, 09:25, 10:30, 11:25
            До: 31.05

            Пн: математика, русский, физра
            Вт 07:40 Нулевой английский
            Вт: английский, -, биология</code>

            Строка «Звонки» задаёт время уроков по порядку, строка дня расставляет по ним предметы.
            Прочерк — окно. Урок вне сетки пишется со своим временем. «До» необязательно.

            Присланное заменяет прежнее расписание целиком.""";

    /** Одна фраза на все причины: разбираться человеку тут не в чем, формат перед глазами. */
    public static final String SCHOOL_NOT_PARSED =
            "Не понял расписание. Проверь формат: день, время, предмет — и «Звонки», если "
                    + "расставляешь предметы по порядку.";
