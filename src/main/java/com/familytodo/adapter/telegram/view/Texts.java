...
public final class Texts {
    ...
    /**
     * Повторение доступно, только когда исполнитель один: серия хранит одного исполнителя.
     *
     * <p>Сообщаем явно, а не пропускаем шаг молча: иначе человек, у которого вопрос про повторение
     * был вчера и не появился сегодня, решит, что бот сломался.
     */
    public static final String NO_REPEAT_FOR_SEVERAL =
            "Повторяющимся такое дело сделать нельзя — повторение доступно, когда исполнитель один.";
