...
public class SchoolService {
    ...
    /** Всё, что этому участнику положено видеть: ребёнку своё, родителю — всех детей семьи. */
    public List<Lesson> visibleTo(Member viewer) {
        return lessons.findVisible(
                viewer.familyId(), viewer.role() == Role.CHILD ? viewer.id() : null);
    }
